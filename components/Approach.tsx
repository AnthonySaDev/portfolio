    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Vamos colaborar para mapear os objetivos do seu site, o público-alvo
          e as principais funcionalidades. Discutiremos a estrutura do site, 
        ...
        <Card
          ...
          des="Após concordarmos com o plano, coloco minha playlist de lo-fi e começo
          a trabalhar. Desde os primeiros esboços até o código finalizado, eu mantenho você atualizado
          em cada etapa."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="Aqui é onde a mágica acontece! Com base no design aprovado,
          vou traduzir tudo em código funcional, construindo seu site
          do zero e irei hospedá-lo para que todos tenham acesso."
        >
          <CanvasRevealEffect
            animationSpeed={3}
